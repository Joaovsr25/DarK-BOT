...
const prefix = '+'
const botName = [`${infos.botName}@s.whatsapp.net`] 
const ownerNumber = [`${infos.ownerNumber}@s.whatsapp.net`] 
const ownerName = [`${infos.ownerName}@s.whatsapp.net`] 
const premNumber = [`${infos.premNumber}@s.whatsapp.net`] 
const cdd = 480000 // 8 minutos
const ammOff = "off"
const blocked = []

//_LISTA DE CRS
const cr = "client-BOT v12.4"
...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('👆'), color(' Escanear o código acima para iniciar o client-BOT!'))
	})

	fs.existsSync('./client.json') && client.loadAuthInfo('./client.json')
	client.on('connecting', () => {
		start('2', 'Conectando o client-BOT...')
	})
	client.on('open', () => {
		success('2', 'client-BOT conectado!!!')
	})
...
//_"Es hora de mimir" By: Resen
			...
			if (horaAtual == "10:10:00" && ammOff == "off" && isGroup) {
				...
				client.sendMessage(from, sonica, MessageType.audio, {mimetype: 'audio/mp4', ptt:true})
				client.sendMessage(from, sonico, sticker)
				ammOff = "on"
...
//_FUCTION NOME DOS STICKERS
				...
				if (!packname) packname = 'client-BOT'; if (!author) author = 'Bot';	
...
await axios.get(`https://nekos.life/api/v2/img/pussy_jpg`).then((res) => {
	client.sendMessage(from, '[🦧] ESPERE ESTA PROCESSANDO...', MessageType.text)
   // let cpf = ${res.data.url}
    client.sendMessage(from, res.data.url,MessageType.image);
})
}*/
...
axios.get(`http://geradorapp.com/api/v1/cpf/generate?token=40849779ec68f8351995def08ff1e2fa`).then((res) => {
    ...
    client.sendMessage(from, cpf,MessageType.text);
})
}
...
switch(anun) {
case 'dança':
buf = fs.readFileSync(`./teste/client.webp`)
client.sendMessage(from, buf, sticker, {quoted: mek})
break
...
case 'esh':
client.sendMessage(from, esh, text, {quoted: mek})
break
...
client.sendMessage(from, `https://github.com/italuH/client-BOT` , text, {quoted: mek})
break
...
addBan(body.slice(4))
client.sendMessage(from, `você foi banido ${body.slice(4)}@c.us`, text)
break
...
client.sendMessage(from, sapa, {quoted: mek})
break
...
case 'jsonfiles':
						...
						client.sendMessage(from, diariofile, document, {mimetype: 'json', filename: 'diario.json'})
						const levelfile = fs.readFileSync('./database/json/level.json')
						client.sendMessage(from, levelfile, document, {mimetype: 'json', filename: 'level.json'})
						const levelingfile = fs.readFileSync('./database/json/leveling.json')
						client.sendMessage(from, levelingfile, document, {mimetype: 'json', filename: 'leveling.json'})
						const nsfwfile = fs.readFileSync('./database/json/nsfw.json')
						client.sendMessage(from, nsfwfile, document, {mimetype: 'json', filename: 'nsfw.json'})
						const simifile = fs.readFileSync('./database/json/simi.json')
						client.sendMessage(from, simifile, document, {mimetype: 'json', filename: 'simi.json'})
						const tictactoefile = fs.readFileSync('./database/ttt/tictactoe.json')
						client.sendMessage(from, tictactoefile, document, {mimetype: 'json', filename: 'tictactoe.json'})
						const userfile = fs.readFileSync('./database/json/user.json')
						client.sendMessage(from, userfile, document, {mimetype: 'json', filename: 'user.json'})
						const welkomfile = fs.readFileSync('./database/json/welkom.json')
						client.sendMessage(from, welkomfile, document, { mimetype: 'json', filename: 'welkom.json'})
					break
...
client.sendMessage(from, feg, MessageType.image)
break
...
//_ENVIA O VCARD
case 'italu':
const sentMsg  = await client.sendMessage(from, {displayname: "Italu🧙‍♂️", vcard: vcard}, MessageType.contact)
break
                    case 'leaderboard':
				case 'lb':
...
break
		...
		case 'kuni':
				...
				if (isBanned) return reply(mess.erro.ban)
					...
					client.sendMessage(from, nye, image, { caption: 'kyaa one chan!!', quoted: mek })
					await limitAdd(sender)
					break 
...
case 'togif':
      ...
      case 'holo':
				...
				client.sendMessage(from, nan, sticker, {quoted: mek})
				break
...
hah = fs.readFileSync(ran)
client.sendMessage(from, hah, audio, {mimetype: 'audio/mp3/ptt/mp4', ptt:true, quoted: mek})
fs.unlinkSync(ran)
})
break
...
client.sendMessage(from, italuft, image, {quoted: mek, caption: `☆━✪🕴  ∴₰Ⱦꪋℓo፝֯֟ ߷  🕴✪━☆\n\nChat do baiano: wa.me/+5574999510904`})
break
...
msgFilter.isFiltered(from)
 ...
 `‣ Nome do bot: ${me.name}
  ...
  client.sendMessage(from, buffer, image, {caption: inf, contextInfo: {mentionedJid: [me.jid]}})
  break
...
` 
  ...
  ‣Descrição:
  ${desc ? desc : ''}`
client.sendMessage(from, buffer, image, {quoted: mek, caption: infogp})
break
...
client.sendMessage(from, buffer, image, {quoted: mek, caption: 'nyan!'})
} catch (e) {
console.log(`Error :`, color(e,'red'))
...
client.sendMessage(from, buffer, image, {quoted: mek, caption: `${hehe.name}`})
} catch (e) {
console.log(`Error :`, color(e,'red'))
reply('❌ocorreu um erro❌')
}
...
client.sendMessage(from, hah.url, image, {quoted:mek})
break
...
client.sendMessage(from, hehe, text, {quoted: mek})
break
...
case 'nekogif':
await client.sendMessage(from, { url: `http://api.lolhuman.xyz/api/random2/nsfw_neko_gif?apikey=847de7716f17a51eeba4235c`}, MessageType.video, { mimetype: Mimetype.gif, caption: "teste!" })
break
...
case 'tl':
if (args.length < 1) return client.sendMessage(from, `digite da forma correta: ${prefix}tl texto/língua`, text, {
  quoted: mek
})
var pc = body.slice(3)
nomor = pc.split("/")[0];
...
client.sendMessage(from, 'o nome do grupo foi alterado', text, {
  quoted: mek
})
break
...
client.sendMessage(from, 'a descrição do grupo atualizada', text, {
  quoted: mek
})
break
                      ...
                      if (!q.includes('|')) return reply(`Você deve digitar o nome do pacote e criador dessa forma:\nComando: ${prefix}fign nome do pack|nome do autor\nExemplo: ${prefix}fign Pack nagatoro1|Italu`)
						...
						await removeBackgroundFromImageFile({path: media, apiKey: keyrmbg, size: 'auto', type: 'auto', ranp}).then(res => {
							...
							exec(`ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${ranw}`, (err) => {
								fs.unlinkSync(ranp)
								if (err) return reply(mess.error.stick)
								exec(`webpmux -set exif ${addMetadata('client-BOT', authorname)} ${ranw} -o ${ranw}`, async (error) => {
									if (error) return reply(mess.error.stick)
                ...
                case 'figurinha':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								console.log('Finish')
								exec(`webpmux -set exif ${addMetadata('client-BOT', authorname)} ${ran} -o ${ran}`, async (error) => {
...
case 'stk':
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								console.log(`Error : ${err}`)
                                exec(`webpmux -set exif ${addMetadata('client-BOT', authorname)} ${rano} -o ${rano}`, async (error) => {
								fs.unlinkSync(media)
								reply(mess.error.stick)
							})
                      })
			...
			case 'liststik':
				...
				client.sendMessage(from, lt.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": setiker } })
				break
			...
			case 'totaluser':
				...
				client.sendMessage(from, ts.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": _registered} })
				break
			...
			case 'vnlist':
				...
				client.sendMessage(from, la.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": audionye } })
				break
			...
			case 'listimg':
				...
				client.sendMessage(from, li.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": imagenye } })
				break
...
exec(`ffmpeg -i ${anum} -vf scale=500:-1 -t 10 -r 10 ${ran}`, (err) => {
  ...
  if (err) return reply('❌falha ao converter sticker para gif❌')
  buffer = fs.readFileSync(ran)
  client.sendMessage(from, buffer, MessageType.video, { mimetype: Mimetype.gif, caption: "teste!" })
  fs.unlinkSync(ran)
})
break
...
case 'oculto':
            ...
            client.sendMessage(from, xvidd, text, {quoted: mek, contextInfo: {mentionedJid: [mem]}})
            break
...
client.sendMessage(from, figa, sticker, {quoted: mek})
setTimeout( () => {
reply('Apontando...')
}, 2000)
if (tpa == "vazio") {
				...
				case 'ttt':
					...
					case 'tttrank':
						...
						try {
							...
							await client.sendMessage(from, board, text, {quoted: mek, contextInfo: {mentionedJid: [tictactoe[0].jid, tictactoe[1].jid, tictactoe[2].jid, tictactoe[3].jid, tictactoe[4].jid]}})
						} catch (err) {
							console.log(err)
						}
					break
							...
							if (coordX != 'a1' && coordX != 'a2' && coordX != 'a3' &&
								...
								if (WinnerX()) {
									...
									if (isLevelingOn) {
										...
										client.sendMessage(from, `🎉🎉 VITÓRIA DO client-BOT 🎉🎉\n\n➣  PUNIÇÃO: ${randomTTTXP} XP 🔮`, text)
									} else {
										client.sendMessage(from, `🎉🎉 VITÓRIA DO client-BOT 🎉🎉`, text)
									}
...
client.sendMessage(from, ggf.url, text, {quoted: mek})
break
...
client.sendMessage(from, ggf, text, {quoted: mek})
break

case 'teta':
tits = await dl(`https://meme-api.herokuapp.com/gimme/tits`, {method: 'get'})
client.sendMessage(from, tits.url, '', { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "client-BOT v12.3🧙‍♂️", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('teste/bot.jpg')}}}})
break
